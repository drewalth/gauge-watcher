...
extension DependencyValues {
  public var gaugeService: GaugeService {
...
extension GaugeReadingQuery {
  ...
  public static func all(gaugeID: Gauge.ID, limit: Int? = 1000) -> GaugeReadingQuery {
    GaugeReadingQuery(gaugeID: gaugeID, limit: limit)
  }

  /// Returns readings for a specific metric
  public static func forMetric(_ metric: String, gaugeID: Gauge.ID, limit: Int? = 1000) -> GaugeReadingQuery {
    GaugeReadingQuery(gaugeID: gaugeID, metric: metric, limit: limit)
  }

  /// Returns readings in the last N hours
  public static func lastHours(_ hours: Int, gaugeID: Gauge.ID, metric: String? = nil) -> GaugeReadingQuery {
    let end = Date()
  ...
  public static func lastDays(_ days: Int, gaugeID: Gauge.ID, metric: String? = nil) -> GaugeReadingQuery {
    let end = Date()
