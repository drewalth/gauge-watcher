//
//  GaugeFlowForecastView.swift
//  SharedFeatures
//
//  A collapsible forecast view showing ML-powered flow predictions.
//
...
// MARK: - GaugeFlowForecastView

/// A collapsible view displaying flow forecast data with interactive chart.
public struct GaugeFlowForecastView: View {
    ...
    private var forecastContent: some View {
        ...
        case .initial, .loading:
            loadingView
        case .loaded(let data), .reloading(let data):
            if data.isEmpty {
                emptyForecastView
            } else {
                forecastChart(data)
    ...
    @ViewBuilder
    private func forecastChart(_ data: [ForecastDataPoint]) -> some View {
                    ...
                    Rectangle()
                        ...
                        .onContinuousHover { phase in
                            ...
                            case .active(let location):
                                updateSelectedDataPoint(at: location, proxy: proxy, geometry: geometry, data: data)
                            case .ended:
        ...
        data: [ForecastDataPoint])
    {
        ...
        let closest = data.min { dp1, dp2 in
